...
// arModel is a active record design model for table prop_goods operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of prop_goods.
	Table = "prop_goods"
	// Model is the model object of prop_goods.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table prop_goods.
	Columns = struct {
		Id         string // 自增id                                     
        Name       string // 道具名称                                   
        Image      string // 图片id                                     
        ImageUrl   string // 图片地址                                   
        Type       string // 道具类型 1=岗位红包 2=到面红包 3=企业海报  
        Price      string // 价格，单位：分                             
        Desc       string // 描述                                       
        RowStatus  string // 状态 1=下线 2=上线                         
